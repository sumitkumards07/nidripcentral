...
<html lang="en">
    <head>
        ...
        <title>Accounts Detail | <?php echo $company_name; ?></title>
            ...
            <div class="main-wrapper main-wrapper-1">
                ...
                <div class="main-content">
                    <section class="section">
                        <?php include($AaliLINK_IN."/functions/HTML/accounts-box.php"); ?>
                        <?php include($AaliLINK_IN."/functions/HTML/accounts-table.php"); ?>
                    </section>
                </div>
