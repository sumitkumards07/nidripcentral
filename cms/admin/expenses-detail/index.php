...
<html lang="en">
    <head>
        ...
        <title>Expenses Detail | <?php echo $company_name; ?></title>
            ...
            <div class="main-wrapper main-wrapper-1">
                ...
                <div class="main-content">
                    <section class="section">
                        <?php include($AaliLINK_IN."/functions/HTML/expenses-box.php"); ?>
                        <?php include($AaliLINK_IN."/functions/HTML/expenses-table.php"); ?>
                    </section>
                </div>
