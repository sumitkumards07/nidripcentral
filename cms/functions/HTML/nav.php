...
<div class="app">
    ...
    <aside class="sidebar">
        ...
        <div class="sidebar-menu">
            <a href="<?php echo DOMAIN; ?>/admin/dashboard/" class="menu-item <?php echo (strpos($_SERVER['REQUEST_URI'], 'dashboard') !== false) ? 'active' : ''; ?>">
            ...
            <a href="<?php echo DOMAIN; ?>/admin/view-orders/" class="menu-item <?php echo (strpos($_SERVER['REQUEST_URI'], 'orders') !== false) ? 'active' : ''; ?>">
            ...
            <a href="<?php echo DOMAIN; ?>/admin/users/" class="menu-item <?php echo (strpos($_SERVER['REQUEST_URI'], 'users') !== false) ? 'active' : ''; ?>">
            ...
            <a href="<?php echo DOMAIN; ?>/admin/view-product/" class="menu-item <?php echo (strpos($_SERVER['REQUEST_URI'], 'product') !== false) ? 'active' : ''; ?>">
            ...
            <a href="<?php echo DOMAIN; ?>/admin/banner/" class="menu-item <?php echo (strpos($_SERVER['REQUEST_URI'], 'banner') !== false) ? 'active' : ''; ?>">
            ...
            <a href="<?php echo DOMAIN; ?>/admin/support/" class="menu-item <?php echo (strpos($_SERVER['REQUEST_URI'], 'support') !== false) ? 'active' : ''; ?>">
            ...
            <a href="<?php echo DOMAIN; ?>/admin/sales-report/" class="menu-item <?php echo (strpos($_SERVER['REQUEST_URI'], 'report') !== false) ? 'active' : ''; ?>">
            ...
            <a href="<?php echo DOMAIN; ?>/admin/content/" class="menu-item <?php echo (strpos($_SERVER['REQUEST_URI'], 'content') !== false) ? 'active' : ''; ?>">
